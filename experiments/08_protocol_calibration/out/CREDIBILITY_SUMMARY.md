...
- Degree-2 polynomial nuisance adjustment fails the generic proxy stress tests: joint false-decision rates span 0.000-0.990 across conditional-null cells.
- Degree-6 polynomial adjustment reduces the same conditional-null joint-decision range to 0.000-0.000 while conditional-signal power spans 0.890-1.000.
...
|---|---|---:|---:|
| Generic simulation | polynomial degree 2 | 0.000-0.990 | 1.000-1.000 |
| Generic simulation | polynomial degree 6 | 0.000-0.000 | 0.890-1.000 |
...
| PGDL semi-synthetic | polynomial degree 6 + pairwise interactions | 0.000-0.020 | 0.940-1.000 |
