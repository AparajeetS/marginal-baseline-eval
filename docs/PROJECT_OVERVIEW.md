...
- synthetic and semi-synthetic calibration suites;
- a source-faithful published-study reaudit;
- comparisons against rank, conditional mutual information, and granulated
  criteria;
- a preregistration and frozen claim ledger;
- exploratory image and language-model evidence retained with validity
  warnings.
...
promote exploratory row counts into claims of independent replication.
